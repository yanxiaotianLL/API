...
namespace myselfFast.Fund.Data.Mapping.Banner
{
    public class T_Helo_ImgMap : myselfFastEntityTypeConfiguration<T_Helo_Img>
    {
        public T_Helo_ImgMap()
        {
            ...
            this.Property(t => t.CrtUser)
                .IsRequired()
                .HasMaxLength(50);

            this.Property(t => t.UpdtUser)
                .IsRequired()
                .HasMaxLength(50);
            ...
            this.Property(t => t.CrtTime).HasColumnName("CrtTime");
            this.Property(t => t.CrtUser).HasColumnName("CrtUser");
            this.Property(t => t.UpdtTime).HasColumnName("UpdtTime");
