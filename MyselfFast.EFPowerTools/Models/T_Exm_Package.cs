...
{
    public partial class T_Exm_Package
    {
        ...
        public string mnmale { get; set; }
        public string mnfamale { get; set; }
        public string mnfamalemerry { get; set; }
        public int IsJoint { get; set; }
