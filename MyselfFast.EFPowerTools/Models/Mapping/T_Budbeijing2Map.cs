...
{
    public class T_Budbeijing2Map : EntityTypeConfiguration<T_Budbeijing2>
    {
        public T_Budbeijing2Map()
        {
            // Primary Key
            this.HasKey(t => new { t.Bid, t.市, t.区, t.办公楼, t.拼音, t.地址, t.商圈, t.Quen });
