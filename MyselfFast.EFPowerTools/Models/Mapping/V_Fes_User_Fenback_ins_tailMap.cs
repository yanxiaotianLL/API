...
{
    public class V_Fes_User_Fenback_ins_tailMap : EntityTypeConfiguration<V_Fes_User_Fenback_ins_tail>
    {
        public V_Fes_User_Fenback_ins_tailMap()
        {
            // Primary Key
            this.HasKey(t => new { t.Id, t.Fid, t.FenType, t.Fno, t.Fesid, t.PcId, t.State, t.Fen, t.Optype, t.Opcause, t.Bak, t.OperId, t.OperName, t.ImportTime, t.Hno, t.Cname, t.Ename, t.Usedname, t.Gno, t.CardId, t.Mobile });
            ...
            this.ToTable("V_Fes_User_Fenback_ins_tail");
