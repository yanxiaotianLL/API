...
namespace FescoFast.EFPowerTools.Models.Mapping
{
    public class T_Fes_User_Isreg_BakMap : EntityTypeConfiguration<T_Fes_User_Isreg_Bak>
    {
        public T_Fes_User_Isreg_BakMap()
        {
            ...
            this.ToTable("T_Fes_User_Isreg_Bak");
