...
{
    public class T_Task_Fls_MenuMap : EntityTypeConfiguration<T_Task_Fls_Menu>
    {
        public T_Task_Fls_MenuMap()
        {
            // Primary Key
            this.HasKey(t => new { t.Fid, t.ParentId, t.TypeId, t.Idx });
