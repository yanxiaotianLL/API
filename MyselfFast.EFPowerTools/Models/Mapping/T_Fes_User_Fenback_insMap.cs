...
{
    public class T_Fes_User_Fenback_insMap : EntityTypeConfiguration<T_Fes_User_Fenback_ins>
    {
        public T_Fes_User_Fenback_insMap()
        {
            // Primary Key
            this.HasKey(t => t.Id);
            ...
            this.ToTable("T_Fes_User_Fenback_ins");
            ...
            this.Property(t => t.TotalFen).HasColumnName("TotalFen");
        }
    }
}
