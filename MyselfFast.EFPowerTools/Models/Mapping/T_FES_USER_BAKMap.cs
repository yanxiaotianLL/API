...
namespace FescoFast.EFPowerTools.Models.Mapping
{
    public class T_FES_USER_BAKMap : EntityTypeConfiguration<T_FES_USER_BAK>
    {
        public T_FES_USER_BAKMap()
        {
            ...
            this.Property(t => t.empStatus)
                .HasDatabaseGeneratedOption(DatabaseGeneratedOption.None);

            // Table & Column Mappings
            this.ToTable("T_FES_USER_BAK");
