...
{
    public class T_Gds_Dan_PayMap : EntityTypeConfiguration<T_Gds_Dan_Pay>
    {
        public T_Gds_Dan_PayMap()
        {
            // Primary Key
            this.HasKey(t => t.Id);
