...
{
    public class T_Fes_User_Frostfen_ins_tailMap : EntityTypeConfiguration<T_Fes_User_Frostfen_ins_tail>
    {
        public T_Fes_User_Frostfen_ins_tailMap()
        {
            // Primary Key
            this.HasKey(t => t.Id);
            ...
            this.ToTable("T_Fes_User_Frostfen_ins_tail");
