...
{
    public class T_Fes_User_Fennote_insMap : EntityTypeConfiguration<T_Fes_User_Fennote_ins>
    {
        public T_Fes_User_Fennote_insMap()
        {
            // Primary Key
            this.HasKey(t => t.Id);
            ...
            this.ToTable("T_Fes_User_Fennote_ins");
