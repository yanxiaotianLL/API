...
{
    /**********************************************************************************
     *项目名称	：myselfFast.ZFBZ.Core.Component.Office.xls
     *项目描述  ：
    ...
    ***********************************************************************************/
    ...
    public static class ExportObjectHelper2
    {
        /// <summary>
        /// 导出excel到流
        /// </summary>
            ...
            where T : class
        {
            ...
            //创建workbook
            var workBook = NpoiHelper2.CreateWorkBook();
            for (int i = 0; i < list.NpoiExportModles.Count; i++)
            {
                //创建sheet
                var sheet = workBook.CreateSheet(list.NpoiExportModles[i].SheetName);
                NpoiHelper2.FileDataToSheet<T>(workBook, list.NpoiExportModles[i], sheet);
            }
