...
namespace DependencyRegister.NewSytemSDKConfig
{
    ...
    ***********************************************************************************/
    ...
    {
        private FescoFast.IBLL.IT_Int_TokenuserBLL tokenUserBll =
            ContainerFactory.GetInstance().GetCommonDllContainer().Resolve<FS.IBLL.IT_Int_TokenuserBLL>();
        FescoFast.Component.Logging.ILogger logger = ContainerFactory.GetInstance().GetCommonDllContainer().Resolve<FS.Component.Logging.ILogger>();
