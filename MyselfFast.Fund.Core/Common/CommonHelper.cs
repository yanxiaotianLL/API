...
namespace myselfFast.Fund.Core.Common
{
    ...
    ***********************************************************************************/
    ...
    public partial class CommonHelper
    {
        ...
        //    if (pi == null)
        //        throw new myselfFastException("No property '{0}' found on the instance of type '{1}'.", propertyName, instanceType);
        //    if (!pi.CanWrite)
        //        throw new myselfFastException("The property '{0}' on the instance of type '{1}' does not have a setter.", propertyName, instanceType);
        ...
        //        TypeConverter destinationConverter = destinationType.;
