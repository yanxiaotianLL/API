...
namespace myselfFast.Fund.Core.Common
{
    ...
    public class EmailHelper
    {
        ...
        public EmailHelper(EmailParmars emailParmars)
        {
            this._from = emailParmars.From;
            this._fromName = emailParmars.FromName;
            this._recipient = emailParmars.Recipient;
            this._recipientName = emailParmars.RecipientName;
            this._subject = emailParmars.Subject;
            this._body = emailParmars.Body;
            this._serverHost = emailParmars.ServerHost;
            this._serverPort = emailParmars.ServerPort;
            this._username = emailParmars.Username;
            this._password = emailParmars.Password;
            this._isBodyHtml = emailParmars.IsBodyHtml;
            this._attachment = emailParmars.Attachments;
        }
        /// <summary>  
        /// 初始化一个电子邮件操作类的实例。  
        /// </summary>  
        ...
        public bool Send(ref string message)
        {
            ...
            {
                message = string.Format("{0}:{1}", ex.Message,Recipient);
                return false;
            }
            return true;
        }
